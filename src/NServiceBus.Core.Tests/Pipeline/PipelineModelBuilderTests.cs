namespace NServiceBus.Core.Tests.Pipeline
{
    ...
    public class PipelineModelBuilderTests
    {
        ...
        {
            public override Task Invoke(IParentContext context, CancellationToken cancellationToken, Func<IChildContext, CancellationToken, Task> stage)
            {
        ...
        {
            public override Task Invoke(IParentContext context, CancellationToken cancellationToken, Func<IChildContextNotInheritedFromParentContext, CancellationToken, Task> stage)
            {
                throw new NotImplementedException();
            }
        }
        ...
        {
            public Task Invoke(IParentContext context, CancellationToken cancellationToken, Func<IParentContext, CancellationToken, Task> next)
            {
                throw new NotImplementedException();
            }
        }
        ...
        {
            public Task Invoke(IChildContext context, CancellationToken cancellationToken, Func<IChildContext, CancellationToken, Task> next)
            {
                throw new NotImplementedException();
            }
        }
        ...
        {
            public Task Invoke(IChildContextNotInheritedFromParentContext context, CancellationToken cancellationToken, Func<IChildContextNotInheritedFromParentContext, CancellationToken, Task> next)
            {
                throw new NotImplementedException();
            }
        }
