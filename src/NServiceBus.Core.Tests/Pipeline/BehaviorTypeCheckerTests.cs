namespace NServiceBus.Core.Tests.Pipeline
{
    ...
    public class BehaviorTypeCheckerTests
    {
        ...
        {
            public Task Invoke(IRootContext context, CancellationToken cancellationToken, Func<IRootContext, CancellationToken, Task> next)
            {
        ...
        {
            public Task Invoke(IBehaviorContext context, CancellationToken cancellationToken, Func<IBehaviorContext, CancellationToken, Task> next)
            {
                return Task.CompletedTask;
            }
        }
        ...
        {
            public Task Invoke(IIncomingContext context, CancellationToken cancellationToken, Func<IIncomingContext, CancellationToken, Task> next)
            {
                return Task.CompletedTask;
            }
        }
        ...
        {
            public Task Invoke(IOutgoingContext context, CancellationToken cancellationToken, Func<IOutgoingContext, CancellationToken, Task> next)
            {
                return Task.CompletedTask;
            }
        }
        ...
        {
            public Task Invoke(IAuditContext context, CancellationToken cancellationToken, Func<RootContext, CancellationToken, Task> next)
            {
                return Task.CompletedTask;
            }
        }
        ...
        {
            public Task Invoke(RootContext context, CancellationToken cancellationToken, Func<RootContext, CancellationToken, Task> next)
            {
                return Task.CompletedTask;
            }
        }
        ...
        {
            public abstract Task Invoke(IRootContext context, CancellationToken cancellationToken, Func<IRootContext, CancellationToken, Task> next);
        }
    }
}