    ...
    public class PipelineTests
    {
        ...
        class StageFork : IStageForkConnector<ITransportReceiveContext, IIncomingPhysicalMessageContext, IBatchDispatchContext>
        {
            ...
            public async Task Invoke(ITransportReceiveContext context, CancellationToken cancellationToken, Func<IIncomingPhysicalMessageContext, CancellationToken, Task> next)
            {
                ...
                await next(physicalMessageContext, CancellationToken.None).ConfigureAwait(false);
        ...
        class Stage1 : StageConnector<IIncomingPhysicalMessageContext, IIncomingLogicalMessageContext>
        {
            ...
            public override Task Invoke(IIncomingPhysicalMessageContext context, CancellationToken cancellationToken, Func<IIncomingLogicalMessageContext, CancellationToken, Task> stage)
            {
                context.PrintInstanceWithRunSpecificIfPossible(instance, writer);
        ...
        class Stage2 : StageConnector<IIncomingLogicalMessageContext, IDispatchContext>
        {
            ...
            public override Task Invoke(IIncomingLogicalMessageContext context, CancellationToken cancellationToken, Func<IDispatchContext, CancellationToken, Task> stage)
            {
                context.PrintInstanceWithRunSpecificIfPossible(instance, writer);
