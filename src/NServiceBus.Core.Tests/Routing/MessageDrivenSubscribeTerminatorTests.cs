namespace NServiceBus.Core.Tests.Routing
{
    ...
    public class MessageDrivenSubscribeTerminatorTests
    {
        ...
        public async Task Should_include_TimeSent_and_Version_headers()
        {
            ...
            await subscribeTerminator.Invoke(new TestableSubscribeContext(), CancellationToken.None, (ctx, tkn) => Task.CompletedTask);
            await unsubscribeTerminator.Invoke(new TestableUnsubscribeContext(), CancellationToken.None, (ctx, tkn) => Task.CompletedTask);
        ...
        public async Task Should_Dispatch_according_to_max_retries_when_dispatch_fails()
        {
            ...
            await subscribeTerminator.Invoke(context, CancellationToken.None, (ctx, tkn) => Task.CompletedTask);
