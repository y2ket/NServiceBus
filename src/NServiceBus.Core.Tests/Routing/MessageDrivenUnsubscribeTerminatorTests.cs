namespace NServiceBus.Core.Tests.Routing
{
    ...
    public class MessageDrivenUnsubscribeTerminatorTests
    {
        ...
        {
            await terminator.Invoke(new TestableUnsubscribeContext(), CancellationToken.None, (ctx, tkn) => Task.CompletedTask);
        ...
        public async Task Should_Dispatch_according_to_max_retries_when_dispatch_fails()
        {
            ...
            await terminator.Invoke(context, CancellationToken.None, (ctx, tkn) => Task.CompletedTask);
        ...
        public void Should_Throw_when_max_retries_reached()
        {
            ...
            Assert.That(async () => await terminator.Invoke(context, CancellationToken.None, (ctx, tkn) => Task.CompletedTask), Throws.InstanceOf<QueueNotFoundException>());
