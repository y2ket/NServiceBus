namespace NServiceBus.AcceptanceTests.Recoverability
{
    ...
    public class When_transactionscope_message_is_moved_to_error_queue : NServiceBusAcceptanceTest
    {
        ...
        {
            public async Task Invoke(ITransportReceiveContext context, CancellationToken cancellationToken, Func<ITransportReceiveContext, CancellationToken, Task> next)
            {
