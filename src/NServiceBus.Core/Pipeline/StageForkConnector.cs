namespace NServiceBus.Pipeline
{
    ...
    {
        /// <inheritdoc />
        public Task Invoke(TFromContext context, CancellationToken cancellationToken, Func<TToContext, CancellationToken, Task> next)
        {
        ...
        public abstract Task Invoke(TFromContext context, CancellationToken cancellationToken, Func<TToContext, CancellationToken, Task> stage, Func<TForkContext, Task> fork);
    }
}