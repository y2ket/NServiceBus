namespace NServiceBus
{
    ...
    class LoadHandlersConnector : StageConnector<IIncomingLogicalMessageContext, IInvokeHandlerContext>
    {
        ...
        public override async Task Invoke(IIncomingLogicalMessageContext context, CancellationToken cancellationToken, Func<IInvokeHandlerContext, CancellationToken, Task> stage)
        {
