namespace NServiceBus
{
    ...
    class SendConnector : StageConnector<IOutgoingSendContext, IOutgoingLogicalMessageContext>
    {
        ...
        public override async Task Invoke(IOutgoingSendContext context, CancellationToken cancellationToken, Func<IOutgoingLogicalMessageContext, CancellationToken, Task> stage)
        {
