namespace NServiceBus
{
    ...
    {
        public override Task Invoke(IOutgoingPublishContext context, CancellationToken cancellationToken, Func<IOutgoingLogicalMessageContext, CancellationToken, Task> stage)
        {
