namespace NServiceBus
{
    ...
    {
        public override async Task Invoke(IOutgoingReplyContext context, CancellationToken cancellationToken, Func<IOutgoingLogicalMessageContext, CancellationToken, Task> stage)
        {
